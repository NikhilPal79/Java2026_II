...
1. IS A RELATION [INHERITANCE][INHERITENCE IS TIGHT COUPLING ]
...
# this keyword ===> refer to object of class 
# super keyword ====> refers to super class [it is always the first line to be called in child constructor ]


# OBJECT CLASS IS THE PARENT CLASS OF THE ALL THE CLASS [CALLING THE PARENT CLASS CONSTRUCTOR ] 
